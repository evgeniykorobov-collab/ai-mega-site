...
export default function App() {
  ...
  // Первый экран — самое дорогое место на странице. Здесь были декоративные
  // «Инициализация системы» и «Запуск ядра ИИ», не сообщавшие ничего.
  // Теперь: арифметика, которую не оспорить, и факт из биографии основателя.
  const fullText = `> Рабочая неделя — 45 часов из 168.
> Остальные 73% заявка ждёт утра.
> Отвечает тот, у кого это автоматизировано.
> Двадцать лет мы строили эти процессы людьми.
> Последние два года заменяем их системами.`;
